import {
  ...
  zoom_default
} from "./chunk-KJHY572E.js";
import {
  dispatch_default,
  now,
  timeout_default,
  timer
} from "./chunk-6KL5WK7F.js";
...
function styleMaybeRemove(id2, name) {
  ...
  return function() {
    var schedule = set(this, id2), on = schedule.on, listener = schedule.value[key] == null ? remove2 || (remove2 = styleRemove(name)) : void 0;
...
var polyInOut = function custom3(e) {
  ...
  function polyInOut2(t2) {
    return ((t2 *= 2) <= 1 ? Math.pow(t2, e) : 2 - Math.pow(2 - t2, e)) / 2;
  }
...
var elasticIn = function custom7(a, p) {
  ...
  function elasticIn2(t2) {
    return a * tpmt(- --t2) * Math.sin((s - t2) / p);
  }
...
var elasticOut = function custom8(a, p) {
  ...
  function elasticOut2(t2) {
    return 1 - a * tpmt(t2 = +t2) * Math.sin((t2 + s) / p);
  }
...
var elasticInOut = function custom9(a, p) {
  ...
  function elasticInOut2(t2) {
    return ((t2 = t2 * 2 - 1) < 0 ? a * tpmt(-t2) * Math.sin((s - t2) / p) : 2 - a * tpmt(t2) * Math.sin((s + t2) / p)) / 2;
  }
...
function zoom_default2() {
  ...
  function schedule(transition2, transform3, point, event) {
    transition2.on("start.zoom", function() {
      ...
      var that = this, args = arguments, g = gesture(that, args).event(event), e = extent.apply(that, args), p = point == null ? centroid(e) : typeof point === "function" ? point.apply(that, args) : point, w = Math.max(e[1][0] - e[0][0], e[1][1] - e[0][1]), a = that.__zoom, b = typeof transform3 === "function" ? transform3.apply(that, args) : transform3, i = interpolate(a.invert(p).concat(w / a.k), b.invert(p).concat(w / b.k));
      return function(t2) {
        if (t2 === 1) t2 = b;
        else {
          var l = i(t2), k = w / l[2];
  ...
  function dblclicked(event, ...args) {
    ...
    else select_default(this).call(zoom2.transform, t1, p0, event);
  }
  ...
  zoom2.wheelDelta = function(_) {
    return arguments.length ? (wheelDelta = typeof _ === "function" ? _ : constant_default2(+_), zoom2) : wheelDelta;
  };
  zoom2.filter = function(_) {
    return arguments.length ? (filter2 = typeof _ === "function" ? _ : constant_default2(!!_), zoom2) : filter2;
  };
  zoom2.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default2(!!_), zoom2) : touchable;
  };
  zoom2.extent = function(_) {
    return arguments.length ? (extent = typeof _ === "function" ? _ : constant_default2([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom2) : extent;
  };
...
function arrayMap(array, iteratee2) {
  var index6 = -1, length = array == null ? 0 : array.length, result2 = Array(length);
  while (++index6 < length) {
    result2[index6] = iteratee2(array[index6], index6, array);
  }
  return result2;
}
...
var constant_default3 = constant;
...
function arrayEach(array, iteratee2) {
  var index6 = -1, length = array == null ? 0 : array.length;
  while (++index6 < length) {
    if (iteratee2(array[index6], index6, array) === false) {
      break;
    }
  }
  return array;
...
function baseFindIndex(array, predicate, fromIndex, fromRight) {
  var length = array.length, index6 = fromIndex + (fromRight ? 1 : -1);
  while (fromRight ? index6-- : ++index6 < length) {
    if (predicate(array[index6], index6, array)) {
      return index6;
    }
  }
  return -1;
...
function strictIndexOf(array, value, fromIndex) {
  var index6 = fromIndex - 1, length = array.length;
  while (++index6 < length) {
    if (array[index6] === value) {
      return index6;
    }
  }
  return -1;
...
function reorder(array, indexes) {
  ...
  while (length--) {
    ...
    array[length] = isIndex_default(index6, arrLength) ? oldArray[index6] : void 0;
  }
  return array;
}
...
function replaceHolders(array, placeholder) {
  var index6 = -1, length = array.length, resIndex = 0, result2 = [];
  while (++index6 < length) {
    var value = array[index6];
    if (value === placeholder || value === PLACEHOLDER) {
      array[index6] = PLACEHOLDER;
      result2[resIndex++] = index6;
    }
  }
  return result2;
}
...
function createHybrid(func, bitmask, thisArg, partials, holders, partialsRight, holdersRight, argPos, ary2, arity) {
  ...
  function wrapper() {
    var length = arguments.length, args = Array(length), index6 = length;
    while (index6--) {
...
function createCurry(func, bitmask, arity) {
  ...
  function wrapper() {
    var length = arguments.length, args = Array(length), index6 = length, placeholder = getHolder_default(wrapper);
    while (index6--) {
      args[index6] = arguments[index6];
    }
...
function overRest(func, start2, transform3) {
  ...
  return function() {
    var args = arguments, index6 = -1, length = nativeMax4(args.length - start2, 0), array = Array(length);
    while (++index6 < length) {
      array[index6] = args[start2 + index6];
    }
    index6 = -1;
...
function isIterateeCall(value, index6, object) {
  ...
  if (type == "number" ? isArrayLike_default(object) && isIndex_default(index6, object.length) : type == "string" && index6 in object) {
    return eq_default(object[index6], value);
  }
  return false;
}
...
function baseTimes(n, iteratee2) {
  ...
  while (++index6 < n) {
    result2[index6] = iteratee2(index6);
  }
  return result2;
}
...
function baseGet(object, path) {
  ...
  while (object != null && index6 < length) {
    object = object[toKey_default(path[index6++])];
  }
  return index6 && index6 == length ? object : void 0;
}
...
function baseAt(object, paths) {
  var index6 = -1, length = paths.length, result2 = Array(length), skip = object == null;
  while (++index6 < length) {
    result2[index6] = skip ? void 0 : get_default(object, paths[index6]);
  }
  return result2;
}
...
function arrayPush(array, values2) {
  var index6 = -1, length = values2.length, offset = array.length;
  while (++index6 < length) {
    array[offset + index6] = values2[index6];
  }
  return array;
}
...
function baseFlatten(array, depth, predicate, isStrict, result2) {
  var index6 = -1, length = array.length;
...
function baseSlice(array, start2, end) {
  ...
  while (++index6 < length) {
    result2[index6] = array[index6 + start2];
  }
  return result2;
}
...
function arrayReduce(array, iteratee2, accumulator, initAccum) {
  var index6 = -1, length = array == null ? 0 : array.length;
  if (initAccum && length) {
    accumulator = array[++index6];
  }
  while (++index6 < length) {
    accumulator = iteratee2(accumulator, array[index6], index6, array);
  }
  return accumulator;
}
...
var camelCase = createCompounder_default(function(result2, word, index6) {
  word = word.toLowerCase();
  return result2 + (index6 ? capitalize_default(word) : word);
});
...
function chunk(array, size2, guard) {
  ...
  var index6 = 0, resIndex = 0, result2 = Array(nativeCeil(length / size2));
  while (index6 < length) {
    result2[resIndex++] = baseSlice_default(array, index6, index6 += size2);
  }
  return result2;
}
...
function arrayFilter(array, predicate) {
  var index6 = -1, length = array == null ? 0 : array.length, resIndex = 0, result2 = [];
  while (++index6 < length) {
    var value = array[index6];
    if (predicate(value, index6, array)) {
...
function concat() {
  ...
  var args = Array(length - 1), array = arguments[0], index6 = length;
  while (index6--) {
...
function equalArrays(array, other, bitmask, customizer, equalFunc, stack) {
  ...
  var index6 = -1, result2 = true, seen = bitmask & COMPARE_UNORDERED_FLAG ? new SetCache_default() : void 0;
  stack.set(array, other);
  stack.set(other, array);
  while (++index6 < arrLength) {
    var arrValue = array[index6], othValue = other[index6];
    if (customizer) {
      var compared = isPartial ? customizer(othValue, arrValue, index6, other, array, stack) : customizer(arrValue, othValue, index6, array, other, stack);
    }
    if (compared !== void 0) {
      if (compared) {
        continue;
...
function mapToArray(map2) {
  var index6 = -1, result2 = Array(map2.size);
  map2.forEach(function(value, key) {
    result2[++index6] = [key, value];
  });
  return result2;
}
...
function createBaseFor(fromRight) {
  return function(object, iteratee2, keysFunc) {
    var index6 = -1, iterable = Object(object), props = keysFunc(object), length = props.length;
    while (length--) {
...
var countBy = createAggregator_default(function(result2, value, key) {
  if (hasOwnProperty16.call(result2, key)) {
    ++result2[key];
  } else {
...
var defaults = baseRest_default(function(object, sources) {
  ...
  while (++index6 < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === void 0 || eq_default(value, objectProto19[key]) && !hasOwnProperty17.call(object, key)) {
...
function arrayIncludesWith(array, value, comparator) {
  var index6 = -1, length = array == null ? 0 : array.length;
  while (++index6 < length) {
    if (comparator(value, array[index6])) {
      return true;
    }
  }
  return false;
...
function baseDifference(array, values2, iteratee2, comparator) {
  var index6 = -1, includes2 = arrayIncludes_default, isCommon = true, length = array.length, result2 = [], valuesLength = values2.length;
  if (!length) {
    return result2;
  }
  if (iteratee2) {
  ...
  outer:
    while (++index6 < length) {
      var value = array[index6], computed = iteratee2 == null ? value : iteratee2(value);
...
function baseWhile(array, predicate, isDrop, fromRight) {
  var length = array.length, index6 = fromRight ? length : -1;
  while ((fromRight ? index6-- : ++index6 < length) && predicate(array[index6], index6, array)) {
  }
  return isDrop ? baseSlice_default(array, fromRight ? 0 : index6, fromRight ? index6 + 1 : length) : baseSlice_default(array, fromRight ? index6 + 1 : 0, fromRight ? length : index6);
}
...
function baseEvery(collection, predicate) {
  var result2 = true;
  baseEach_default(collection, function(value, index6, collection2) {
...
function createFind(findIndexFunc) {
  return function(collection, predicate, fromIndex) {
    ...
    return index6 > -1 ? iterable[iteratee2 ? collection[index6] : index6] : void 0;
  };
}
...
function findIndex(array, predicate, fromIndex) {
  ...
  var index6 = fromIndex == null ? 0 : toInteger_default(fromIndex);
  if (index6 < 0) {
    index6 = nativeMax6(length + index6, 0);
  }
  return baseFindIndex_default(array, baseIteratee_default(predicate, 3), index6);
}
...
function findLastIndex(array, predicate, fromIndex) {
  ...
  var index6 = length - 1;
  if (fromIndex !== void 0) {
    index6 = toInteger_default(fromIndex);
    index6 = fromIndex < 0 ? nativeMax7(length + index6, 0) : nativeMin4(index6, length - 1);
  }
  return baseFindIndex_default(array, baseIteratee_default(predicate, 3), index6, true);
}
...
function baseMap(collection, iteratee2) {
  var index6 = -1, result2 = isArrayLike_default(collection) ? Array(collection.length) : [];
  baseEach_default(collection, function(value, key, collection2) {
...
function createFlow(fromRight) {
  return flatRest_default(function(funcs) {
    var length = funcs.length, index6 = length, prereq = LodashWrapper_default.prototype.thru;
    if (fromRight) {
      funcs.reverse();
    }
    while (index6--) {
...
function baseInRange(number, start2, end) {
  return number >= nativeMin5(start2, end) && number < nativeMax8(start2, end);
}
...
function indexOf(array, value, fromIndex) {
  ...
  var index6 = fromIndex == null ? 0 : toInteger_default(fromIndex);
  if (index6 < 0) {
    index6 = nativeMax10(length + index6, 0);
  }
  return baseIndexOf_default(array, value, index6);
}
...
function baseIntersection(arrays, iteratee2, comparator) {
  ...
  outer:
    while (++index6 < length && result2.length < maxLength) {
      var value = array[index6], computed = iteratee2 ? iteratee2(value) : value;
      value = comparator || value !== 0 ? value : 0;
...
var nativeObjectToString = objectProto22.toString;
var invert = createInverter_default(function(result2, value, key) {
  if (value != null && typeof value.toString != "function") {
    value = nativeObjectToString.call(value);
  }
  result2[value] = key;
}, constant_default3(identity_default));
...
var invertBy = createInverter_default(function(result2, value, key) {
  ...
  if (hasOwnProperty20.call(result2, value)) {
...
var invokeMap = baseRest_default(function(collection, path, args) {
  var index6 = -1, isFunc = typeof path == "function", result2 = isArrayLike_default(collection) ? Array(collection.length) : [];
  baseEach_default(collection, function(value) {
    result2[++index6] = isFunc ? apply_default(path, value, args) : baseInvoke_default(value, path, args);
  });
  return result2;
});
...
var kebabCase = createCompounder_default(function(result2, word, index6) {
...
function lastIndexOf(array, value, fromIndex) {
  ...
  if (fromIndex !== void 0) {
    index6 = toInteger_default(fromIndex);
    index6 = index6 < 0 ? nativeMax11(length + index6, 0) : nativeMin7(index6, length - 1);
  }
  return value === value ? strictLastIndexOf_default(array, value, index6) : baseFindIndex_default(array, baseIsNaN_default, index6, true);
}
var lastIndexOf_default = lastIndexOf;

// node_modules/lodash-es/lowerCase.js
var lowerCase = createCompounder_default(function(result2, word, index6) {
  return result2 + (index6 ? " " : "") + word.toLowerCase();
});
...
function baseExtremum(array, iteratee2, comparator) {
  var index6 = -1, length = array.length;
  while (++index6 < length) {
    var value = array[index6], current = iteratee2(value);
...
function baseSum(array, iteratee2) {
  var result2, index6 = -1, length = array.length;
  while (++index6 < length) {
    var current = iteratee2(array[index6]);
    if (current !== void 0) {
...
function baseSet(object, path, value, customizer) {
  ...
  while (nested != null && ++index6 < length) {
    var key = toKey_default(path[index6]), newValue = value;
    ...
    if (index6 != lastIndex) {
      ...
      if (newValue === void 0) {
        newValue = isObject_default(objValue) ? objValue : isIndex_default(path[index6 + 1]) ? [] : {};
      }
    }
...
function basePickBy(object, paths, predicate) {
  ...
  while (++index6 < length) {
    var path = paths[index6], value = baseGet_default(object, path);
...
function compareMultiple(object, other, orders) {
  ...
  while (++index6 < length) {
    var result2 = compareAscending_default(objCriteria[index6], othCriteria[index6]);
    if (result2) {
...
var overArgs = castRest_default(function(func, transforms) {
  ...
  return baseRest_default(function(args) {
    var index6 = -1, length = nativeMin8(args.length, funcsLength);
    while (++index6 < length) {
...
function baseIndexOfWith(array, value, fromIndex, comparator) {
  var index6 = fromIndex - 1, length = array.length;
  while (++index6 < length) {
    if (comparator(array[index6], value)) {
      return index6;
    }
  }
  return -1;
...
function basePullAll(array, values2, iteratee2, comparator) {
  var indexOf2 = comparator ? baseIndexOfWith_default : baseIndexOf_default, index6 = -1, length = values2.length, seen = array;
  if (array === values2) {
...
function basePullAt(array, indexes) {
  ...
  while (length--) {
    ...
    if (length == lastIndex || index6 !== previous) {
      var previous = index6;
      if (isIndex_default(index6)) {
        splice3.call(array, index6, 1);
      } else {
        baseUnset_default(array, index6);
      }
    }
  }
  return array;
...
var pullAt = flatRest_default(function(array, indexes) {
  ...
  basePullAt_default(array, arrayMap_default(indexes, function(index6) {
    return isIndex_default(index6, length) ? +index6 : index6;
...
function baseRange(start2, end, step, fromRight) {
  var index6 = -1, length = nativeMax12(nativeCeil4((end - start2) / (step || 1)), 0), result2 = Array(length);
  while (length--) {
...
function baseReduce(collection, iteratee2, accumulator, initAccum, eachFunc) {
  eachFunc(collection, function(value, index6, collection2) {
    accumulator = initAccum ? (initAccum = false, value) : iteratee2(accumulator, value, index6, collection2);
  });
  return accumulator;
}
...
function remove(array, predicate) {
  ...
  var index6 = -1, indexes = [], length = array.length;
...
function result(object, path, defaultValue) {
  ...
  while (++index6 < length) {
    var value = object == null ? void 0 : object[toKey_default(path[index6])];
    if (value === void 0) {
      index6 = length;
      value = defaultValue;
    }
...
function shuffleSelf(array, size2) {
  var index6 = -1, length = array.length, lastIndex = length - 1;
  size2 = size2 === void 0 ? length : size2;
  while (++index6 < size2) {
    var rand = baseRandom_default(index6, lastIndex), value = array[rand];
    array[rand] = array[index6];
    array[index6] = value;
  }
  array.length = size2;
  return array;
...
var snakeCase = createCompounder_default(function(result2, word, index6) {
...
function sortedIndexOf(array, value) {
  var length = array == null ? 0 : array.length;
  if (length) {
    var index6 = baseSortedIndex_default(array, value);
    if (index6 < length && eq_default(array[index6], value)) {
      return index6;
    }
  }
  return -1;
...
function sortedLastIndexOf(array, value) {
  var length = array == null ? 0 : array.length;
  if (length) {
    var index6 = baseSortedIndex_default(array, value, true) - 1;
    if (eq_default(array[index6], value)) {
      return index6;
    }
  }
  return -1;
...
function baseSortedUniq(array, iteratee2) {
  ...
  while (++index6 < length) {
    var value = array[index6], computed = iteratee2 ? iteratee2(value) : value;
    if (!index6 || !eq_default(computed, seen)) {
      var seen = computed;
...
function spread(func, start2) {
  ...
  start2 = start2 == null ? 0 : nativeMax13(toInteger_default(start2), 0);
  return baseRest_default(function(args) {
...
var startCase = createCompounder_default(function(result2, word, index6) {
  return result2 + (index6 ? " " : "") + upperFirst_default(word);
});
...
function customDefaultsAssignIn(objValue, srcValue, key, object) {
  if (objValue === void 0 || eq_default(objValue, objectProto25[key]) && !hasOwnProperty22.call(object, key)) {
    return srcValue;
  }
  return objValue;
}
...
function template(string, options, guard) {
  ...
  var sourceURL = hasOwnProperty23.call(options, "sourceURL") ? "//# sourceURL=" + (options.sourceURL + "").replace(/\s/g, " ") + "\n" : "";
  string.replace(reDelimiters, function(match, escapeValue, interpolateValue, esTemplateValue, evaluateValue, offset) {
    interpolateValue || (interpolateValue = esTemplateValue);
    source += string.slice(index6, offset).replace(reUnescapedString, escapeStringChar_default);
    if (escapeValue) {
      isEscaping = true;
      source += "' +\n__e(" + escapeValue + ") +\n'";
    }
...
function times(n, iteratee2) {
  ...
  var index6 = MAX_ARRAY_LENGTH6, length = nativeMin11(n, MAX_ARRAY_LENGTH6);
...
function transform2(object, iteratee2, accumulator) {
  ...
  (isArrLike ? arrayEach_default : baseForOwn_default)(object, function(value, index6, object2) {
...
function charsEndIndex(strSymbols, chrSymbols) {
  ...
  while (index6-- && baseIndexOf_default(chrSymbols, strSymbols[index6], 0) > -1) {
  }
  return index6;
}
...
function charsStartIndex(strSymbols, chrSymbols) {
  ...
  while (++index6 < length && baseIndexOf_default(chrSymbols, strSymbols[index6], 0) > -1) {
  }
  return index6;
}
...
function baseUniq(array, iteratee2, comparator) {
  var index6 = -1, includes2 = arrayIncludes_default, length = array.length, isCommon = true, result2 = [], seen = result2;
  if (comparator) {
    isCommon = false;
    includes2 = arrayIncludesWith_default;
...
function unzip(array) {
  ...
  return baseTimes_default(length, function(index6) {
    return arrayMap_default(array, baseProperty_default(index6));
  });
}
...
var upperCase = createCompounder_default(function(result2, word, index6) {
...
function baseXor(arrays, iteratee2, comparator) {
  ...
  var index6 = -1, result2 = Array(length);
  while (++index6 < length) {
    var array = arrays[index6], othIndex = -1;
    while (++othIndex < length) {
      if (othIndex != index6) {
        result2[index6] = baseDifference_default(result2[index6] || array, arrays[othIndex], iteratee2, comparator);
      }
    }
  }
...
function baseZipObject(props, values2, assignFunc) {
  ...
  while (++index6 < length) {
    var value = index6 < valsLength ? values2[index6] : void 0;
  ...
  while (++index6 < length) {
    ...
    switch (data.type) {
      ...
      case "dropRight":
        ...
        break;
      case "take":
        end = nativeMin12(end, start2 + size2);
        break;
      case "takeRight":
        start2 = nativeMax15(start2, end - size2);
        break;
    }
  }
...
function lazyValue() {
  ...
  outer:
    while (length-- && resIndex < takeCount) {
      index6 += dir;
      var iterIndex = -1, value = array[index6];
...
mixin2(wrapperLodash_default, function() {
  ...
  baseForOwn_default(wrapperLodash_default, function(func, methodName) {
    if (!hasOwnProperty24.call(wrapperLodash_default.prototype, methodName)) {
...
arrayEach_default(["drop", "take"], function(methodName, index6) {
  LazyWrapper_default.prototype[methodName] = function(n) {
    n = n === void 0 ? 1 : nativeMax16(toInteger_default(n), 0);
    var result2 = this.__filtered__ && !index6 ? new LazyWrapper_default(this) : this.clone();
...
arrayEach_default(["filter", "map", "takeWhile"], function(methodName, index6) {
  var type = index6 + 1, isFilter = type == LAZY_FILTER_FLAG2 || type == LAZY_WHILE_FLAG;
...
arrayEach_default(["head", "last"], function(methodName, index6) {
  var takeName = "take" + (index6 ? "Right" : "");
  LazyWrapper_default.prototype[methodName] = function() {
    return this[takeName](1).value()[0];
  };
});
arrayEach_default(["initial", "tail"], function(methodName, index6) {
...
baseForOwn_default(LazyWrapper_default.prototype, function(func, methodName) {
  ...
  if (lodashFunc) {
    ...
    if (!hasOwnProperty24.call(realNames_default, key)) {
...
var _default = function() {
  ...
  return _createClass(_default11, [{
    ...
    value: function lookup(color2) {
      ...
      var n = typeof color2 === "string" ? colorStr2Int(color2) : rgb2Int.apply(void 0, _toConsumableArray(color2));
      if (!n) return null;
...
var utils = {
  ...
  roots: function(points, line) {
    ...
    if (order === 2) {
      const a2 = aligned[0].y, b10 = aligned[1].y, c2 = aligned[2].y, d2 = a2 - 2 * b10 + c2;
      if (d2 !== 0) {
        const m1 = -sqrt(b10 * b10 - a2 * c2), m2 = -a2 + b10, v12 = -(m1 + m2) / d2, v2 = -(-m1 + m2) / d2;
        return [v12, v2].filter(reduce2);
      } else if (b10 !== c2 && d2 === 0) {
        return [(2 * b10 - c2) / (2 * b10 - 2 * c2)].filter(reduce2);
      }
      return [];
    }
    ...
    if (discriminant < 0) {
      ...
      x1 = t1 * cos(phi / 3) - a / 3;
      x2 = t1 * cos((phi + tau2) / 3) - a / 3;
      x3 = t1 * cos((phi + 2 * tau2) / 3) - a / 3;
...
var Bezier = class _Bezier {
  ...
  split(t1, t2) {
    ...
    return result2.right.split(t2).left;
  }
  extrema() {
    const result2 = {};
    let roots = [];
    this.dims.forEach(
      (function(dim) {
        ...
        result2[dim] = result2[dim].filter(function(t2) {
          return t2 >= 0 && t2 <= 1;
        });
...
var index5 = function() {
  ...
  var indexedResult = list.reduce(function(res, item) {
    ...
    keys2.forEach(function(_ref, idx) {
      ...
      var key;
      if (isProp) {
        var _itemVal = itemVal, propVal = _itemVal[keyAccessor], rest2 = _objectWithoutProperties(_itemVal, [keyAccessor].map(_toPropertyKey2));
        key = propVal;
        itemVal = rest2;
      } else {
    ...
    (function flatten2(node) {
      ...
      if (accKeys.length === keys2.length) {
        ...
        Object.entries(node).forEach(function(_ref2) {
          ...
          return flatten2(val, [].concat(_toConsumableArray2(accKeys), [key]));
        });
      }
    })(indexedResult);
...
function getDagDepths(_ref, idAccessor) {
  ...
  var nodeDepths = Object.assign.apply(Object, [{}].concat(_toConsumableArray3(Object.entries(graph).filter(function(_ref4) {
    var _ref5 = _slicedToArray2(_ref4, 2), node = _ref5[1];
    return !node.skip;
  }).map(function(_ref6) {
    var _ref7 = _slicedToArray2(_ref6, 2), id2 = _ref7[0], node = _ref7[1];
    ...
    tickFrame: function tickFrame(state) {
      ...
      function paintLinks() {
        ...
        Object.entries(linksPerColor).forEach(function(_ref) {
          var _ref2 = _slicedToArray2(_ref, 2), color2 = _ref2[0], linksPerWidth = _ref2[1];
          var lineColor = !color2 || color2 === "undefined" ? "rgba(0,0,0,0.15)" : color2;
          Object.entries(linksPerWidth).forEach(function(_ref3) {
            var _ref4 = _slicedToArray2(_ref3, 2), width = _ref4[0], linesPerLineDash = _ref4[1];
      ...
      function paintPhotons() {
        ...
        var getOffset = index3(state.linkDirectionalParticleOffset);
...
})).concat(_toConsumableArray3(["nodeRelSize", "nodeId", "nodeVal", "nodeVisibility", "linkSource", "linkTarget", "linkVisibility", "linkCurvature"].map(function(p) {
  return _defineProperty({}, p, bindBoth.linkProp(p));
}))));
var linkedMethods = Object.assign.apply(Object, _toConsumableArray3(["d3Force", "d3ReheatSimulation", "emitParticle"].map(function(p) {
