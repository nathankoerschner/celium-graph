...
function $() {
  for (var n2, u2, t5, r2, o2, f2, c5, s2 = 1; i.length; ) i.length > s2 && i.sort(e), n2 = i.shift(), s2 = i.length, n2.__d && (t5 = void 0, o2 = (r2 = (u2 = n2).__v).__e, f2 = [], c5 = [], u2.__P && ((t5 = d({}, r2)).__v = r2.__v + 1, l.vnode && l.vnode(t5), O(u2.__P, t5, r2, u2.__n, u2.__P.namespaceURI, 32 & r2.__u ? [o2] : null, f2, null == o2 ? S(r2) : o2, !!(32 & r2.__u), c5), t5.__v = r2.__v, t5.__.__k[t5.__i] = t5, N(f2, t5, c5), t5.__e != o2 && C2(t5)));
  $.__r = 0;
}
function I(n2, l2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, y3, w2, d2, g2, _2 = t5 && t5.__k || v, m3 = l2.length;
...
function A2(n2, l2, u2) {
  ...
  if ("function" == typeof n2.type) {
    for (t5 = n2.__k, i2 = 0; t5 && i2 < t5.length; i2++) t5[i2] && (t5[i2].__ = n2, l2 = A2(t5[i2], l2, u2));
    return l2;
  }
