...
function link_default(links) {
  var id = index2, strength = defaultStrength, strengths, distance2 = constant_default(30), distances, nodes, nDim, count2, bias, random, iterations = 1;
  if (links == null) links = [];
  ...
  force.distance = function(_2) {
    return arguments.length ? (distance2 = typeof _2 === "function" ? _2 : constant_default(+_2), initializeDistance(), force) : distance2;
  };
  return force;
}
...
function add_default2(d2) {
  ...
  return add2(this.cover(x3, y3, z3), x3, y3, z3, d2);
}
function add2(tree, x3, y3, z3, d2) {
...
var root_default3 = root;

// node_modules/lodash-es/now.js
var now = function() {
  return root_default3.Date.now();
};
var now_default = now;
...
var Symbol2 = root_default3.Symbol;
...
function max(values, valueof) {
  ...
  if (valueof === void 0) {
    ...
    for (let value of values) {
      if ((value = valueof(value, ++index7, values)) != null && (max2 < value || max2 === void 0 && value >= value)) {
        max2 = value;
      }
    }
  }
...
function min(values, valueof) {
  ...
  if (valueof === void 0) {
    ...
    let index7 = -1;
    for (let value of values) {
      if ((value = valueof(value, ++index7, values)) != null && (min2 > value || min2 === void 0 && value >= value)) {
        min2 = value;
      }
    }
  }
...
function blurfImage(radius) {
  ...
  return (T2, S2, start, stop, step) => {
    start <<= 2, stop <<= 2, step <<= 2;
    blur3(T2, S2, start + 0, stop + 0, step);
    blur3(T2, S2, start + 1, stop + 1, step);
    blur3(T2, S2, start + 2, stop + 2, step);
    blur3(T2, S2, start + 3, stop + 3, step);
  };
}
function blurf(radius) {
  ...
  return (T2, S2, start, stop, step) => {
    ...
    for (let i2 = start, j2 = stop; i2 <= j2; i2 += step) {
      ...
      T2[i2] = (sum2 + t4 * (S2[Math.max(start, i2 - s1)] + S2[Math.min(stop, i2 + s1)])) / w2;
...
function bluri(radius) {
  ...
  return (T2, S2, start, stop, step) => {
    ...
    for (let i2 = start, j2 = start + s2; i2 < j2; i2 += step) {
      sum2 += S2[Math.min(stop, i2)];
    }
    for (let i2 = start, j2 = stop; i2 <= j2; i2 += step) {
...
function shuffler(random) {
  return function shuffle(array3, i0 = 0, i1 = array3.length) {
    let m3 = i1 - (i0 = +i0);
    while (m3) {
      const i2 = random() * m3-- | 0, t4 = array3[m3 + i0];
...
function ordinal() {
  var index7 = new InternMap(), domain = [], range2 = [], unknown = implicit;
  function scale(d2) {
...
function hsl2(hue2) {
  return function(start, end) {
    var h2 = hue2((start = hsl(start)).h, (end = hsl(end)).h), s2 = nogamma(start.s, end.s), l2 = nogamma(start.l, end.l), opacity = nogamma(start.opacity, end.opacity);
    return function(t4) {
      start.h = h2(t4);
      start.s = s2(t4);
      start.l = l2(t4);
...
function hcl2(hue2) {
  return function(start, end) {
    var h2 = hue2((start = hcl(start)).h, (end = hcl(end)).h), c5 = nogamma(start.c, end.c), l2 = nogamma(start.l, end.l), opacity = nogamma(start.opacity, end.opacity);
    return function(t4) {
      start.h = h2(t4);
      start.c = c5(t4);
      start.l = l2(t4);
...
function formatLocale(locale3) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      var string = [], i2 = -1, j2 = 0, n2 = specifier.length, c5, pad3, format2;
      ...
      while (++i2 < n2) {
        if (specifier.charCodeAt(i2) === 37) {
          ...
          if (format2 = formats2[c5]) c5 = format2(date, pad3);
          string.push(c5);
          j2 = i2 + 1;
        }
      }
...
function ramp(range2) {
  ...
  return function(t4) {
    return range2[Math.max(0, Math.min(n2 - 1, Math.floor(t4 * n2)))];
  };
}
...
var removeAll3 = TWEEN.removeAll.bind(TWEEN);
var add3 = TWEEN.add.bind(TWEEN);
...
function data_default3(value, key) {
  ...
  for (var m3 = groups2.length, update3 = new Array(m3), enter = new Array(m3), exit = new Array(m3), j2 = 0; j2 < m3; ++j2) {
    var parent = parents[j2], group2 = groups2[j2], groupLength = group2.length, data = arraylike(value.call(parent, parent && parent.__data__, j2, parents)), dataLength = data.length, enterGroup = enter[j2] = new Array(dataLength), updateGroup = update3[j2] = new Array(dataLength), exitGroup = exit[j2] = new Array(groupLength);
...
function $() {
  for (var n2, u2, t4, r2, o2, f2, c5, s2 = 1; i.length; ) i.length > s2 && i.sort(e), n2 = i.shift(), s2 = i.length, n2.__d && (t4 = void 0, o2 = (r2 = (u2 = n2).__v).__e, f2 = [], c5 = [], u2.__P && ((t4 = d({}, r2)).__v = r2.__v + 1, l.vnode && l.vnode(t4), O(u2.__P, t4, r2, u2.__n, u2.__P.namespaceURI, 32 & r2.__u ? [o2] : null, f2, null == o2 ? S(r2) : o2, !!(32 & r2.__u), c5), t4.__v = r2.__v, t4.__.__k[t4.__i] = t4, N(f2, t4, c5), t4.__e != o2 && C2(t4)));
  $.__r = 0;
}
function I(n2, l2, u2, t4, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, y3, w2, d2, g2, _2 = t4 && t4.__k || v, m3 = l2.length;
  for (f2 = P(u2, l2, _2, f2, m3), a3 = 0; a3 < m3; a3++) null != (y3 = u2.__k[a3]) && (h2 = -1 == y3.__i ? p : _2[y3.__i] || p, y3.__i = a3, g2 = O(n2, y3, h2, i2, r2, o2, e3, f2, c5, s2), w2 = y3.__e, y3.ref && h2.ref != y3.ref && (h2.ref && B2(h2.ref, null, y3), s2.push(y3.ref, y3.__c || w2, y3)), null == d2 && null != w2 && (d2 = w2), 4 & y3.__u || h2.__k === y3.__k ? f2 = A2(y3, f2, n2) : "function" == typeof y3.type && void 0 !== g2 ? f2 = g2 : w2 && (f2 = w2.nextSibling), y3.__u &= -7);
  return u2.__e = d2, f2;
}
function P(n2, l2, u2, t4, i2) {
  var r2, o2, e3, f2, c5, s2 = u2.length, a3 = s2, h2 = 0;
  for (n2.__k = new Array(i2), r2 = 0; r2 < i2; r2++) null != (o2 = l2[r2]) && "boolean" != typeof o2 && "function" != typeof o2 ? (f2 = r2 + h2, (o2 = n2.__k[r2] = "string" == typeof o2 || "number" == typeof o2 || "bigint" == typeof o2 || o2.constructor == String ? m2(null, o2, null, null, null) : w(o2) ? m2(k, { children: o2 }, null, null, null) : null == o2.constructor && o2.__b > 0 ? m2(o2.type, o2.props, o2.key, o2.ref ? o2.ref : null, o2.__v) : o2).__ = n2, o2.__b = n2.__b + 1, e3 = null, -1 != (c5 = o2.__i = L(o2, u2, f2, a3)) && (a3--, (e3 = u2[c5]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c5 && (i2 > s2 ? h2-- : i2 < s2 && h2++), "function" != typeof o2.type && (o2.__u |= 4)) : c5 != f2 && (c5 == f2 - 1 ? h2-- : c5 == f2 + 1 ? h2++ : (c5 > f2 ? h2-- : h2++, o2.__u |= 4))) : n2.__k[r2] = null;
  if (a3) for (r2 = 0; r2 < s2; r2++) null != (e3 = u2[r2]) && 0 == (2 & e3.__u) && (e3.__e == t4 && (t4 = S(e3)), D2(e3, e3));
  return t4;
}
...
function j(n2, l2, u2, t4, i2) {
  ...
  else if ("o" == l2[0] && "n" == l2[1]) r2 = l2 != (l2 = l2.replace(f, "$1")), o2 = l2.toLowerCase(), l2 = o2 in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? o2.slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? t4 ? u2.u = t4.u : (u2.u = c4, n2.addEventListener(l2, r2 ? a2 : s, r2)) : n2.removeEventListener(l2, r2 ? a2 : s, r2);
  else {
...
function O(n2, u2, t4, i2, r2, o2, e3, f2, c5, s2) {
  ...
  n: if ("function" == typeof j2) try {
    if (b = u2.props, S2 = "prototype" in j2 && j2.prototype.render, C3 = (a3 = j2.contextType) && i2[a3.__c], M2 = a3 ? C3 ? C3.props.value : a3.__ : i2, t4.__c ? m3 = (h2 = u2.__c = t4.__c).__ = h2.__E : (S2 ? u2.__c = h2 = new j2(b, M2) : (u2.__c = h2 = new x2(b, M2), h2.constructor = j2, h2.render = E2), C3 && C3.sub(h2), h2.props = b, h2.state || (h2.state = {}), h2.context = M2, h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && null == h2.__s && (h2.__s = h2.state), S2 && null != j2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = d({}, h2.__s)), d(h2.__s, j2.getDerivedStateFromProps(b, h2.__s))), v2 = h2.props, y3 = h2.state, h2.__v = u2, p2) S2 && null == j2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), S2 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
    else {
      if (S2 && null == j2.getDerivedStateFromProps && b !== v2 && null != h2.componentWillReceiveProps && h2.componentWillReceiveProps(b, M2), !h2.__e && null != h2.shouldComponentUpdate && false === h2.shouldComponentUpdate(b, h2.__s, M2) || u2.__v == t4.__v) {
    ...
    h2.state = h2.__s, null != h2.getChildContext && (i2 = d(d({}, i2), h2.getChildContext())), S2 && !p2 && null != h2.getSnapshotBeforeUpdate && (_2 = h2.getSnapshotBeforeUpdate(v2, y3)), L2 = a3, null != a3 && a3.type === k && null == a3.key && (L2 = V(a3.props.children)), f2 = I(n2, w(L2) ? L2 : [L2], u2, t4, i2, r2, o2, e3, f2, c5, s2), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && e3.push(h2), m3 && (h2.__E = h2.__ = null);
  } catch (n3) {
    ...
    else u2.__e = t4.__e, u2.__k = t4.__k, n3.then || z2(u2);
    l.__e(n3, u2, t4);
  }
  else null == o2 && u2.__v == t4.__v ? (u2.__k = t4.__k, u2.__e = t4.__e) : f2 = u2.__e = q(t4.__e, u2, t4, i2, r2, o2, e3, c5, s2);
...
function N(n2, u2, t4) {
  for (var i2 = 0; i2 < t4.length; i2++) B2(t4[i2], t4[++i2], t4[++i2]);
...
function q(u2, t4, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, v2, y3, d2, _2, m3, b = i2.props, k2 = t4.props, x3 = t4.type;
  ...
  if (null == x3) b === k2 || c5 && u2.data == k2 || (u2.data = k2);
    ...
    else if (v2 && (u2.innerHTML = ""), I("template" == t4.type ? u2.content : u2, w(y3) ? y3 : [y3], t4, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e3, f2, e3 ? e3[0] : i2.__k && S(i2, 0), c5, s2), null != e3) for (a3 = e3.length; a3--; ) g(e3[a3]);
...
function D2(n2, u2, t4) {
  ...
  if (i2 = n2.__k) for (r2 = 0; r2 < i2.length; r2++) i2[r2] && D2(i2[r2], u2, t4 || "function" != typeof n2.type);
...
function G(u2, t4, i2) {
  var r2, o2, e3, f2;
  t4 == document && (t4 = document.documentElement), l.__ && l.__(u2, t4), o2 = (r2 = "function" == typeof i2) ? null : i2 && i2.__k || t4.__k, e3 = [], f2 = [], O(t4, u2 = (!r2 && i2 || t4).__k = _(k, null, [u2]), o2 || p, p, t4.namespaceURI, !r2 && i2 ? [i2] : o2 ? null : t4.firstChild ? n.call(t4.childNodes) : null, e3, !r2 && i2 ? i2 : o2 ? o2.__e : t4.firstChild, r2, f2), N(e3, u2, f2);
}
function K2(l2, u2, t4) {
...
}, $.__r = 0, f = /(PointerCapture)$|Capture$/i, c4 = 0, s = F(false), a2 = F(true), h = 0;
...
function hsvToRgb(h2, s2, v2) {
  ...
  s2 = bound01(s2, 100);
  v2 = bound01(v2, 100);
  var i2 = Math.floor(h2), f2 = h2 - i2, p2 = v2 * (1 - s2), q2 = v2 * (1 - f2 * s2), t4 = v2 * (1 - (1 - f2) * s2), mod = i2 % 6, r2 = [v2, q2, p2, p2, t4, v2][mod], g2 = [t4, v2, v2, q2, p2, p2][mod], b = [p2, p2, t4, v2, v2, q2][mod];
  return {
    r: r2 * 255,
    g: g2 * 255,
    b: b * 255
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-KJHY572E.js.map
